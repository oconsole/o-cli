export const dict = {
  ...
  "desktop.menu.help.documentation": "O-CLI Documentation",
  ...
  "desktop.updater.none.message": "You are already using the latest version of O-CLI",
  ...
  "desktop.updater.downloaded.prompt":
    "Version {{version}} of O-CLI has been downloaded, would you like to install it and relaunch?",
  ...
  "desktop.cli.installed.message": "CLI installed to {{path}}\n\nRestart your terminal to use the 'o-cli' command.",
  ...
  "desktop.cli.error.sidecarMissing": "O-CLI binary is missing. Try reinstalling the desktop app.",
